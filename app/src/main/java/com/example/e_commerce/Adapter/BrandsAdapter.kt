...
import com.example.e_commerce.databinding.ViewholderBrandsBinding
...
class BrandsAdapter(private val items: MutableList<BrandModel>) :
    ...
    inner class Viewholder(val binding: ViewholderBrandsBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(
        parent: ViewGroup, viewType: Int
    ): BrandsAdapter.Viewholder {
        val binding = ViewholderBrandsBinding.inflate(
